...
<h4 class="text-center">{{ $Bolim->name }}ga tegishli tavarlar ro'yxati</h4>
<hr>
<div class="col-lg-12 d-flex justify-content-between w-100">
    <h5><span class="fw-bold">Tavarlarning umumiy asl baxosi:</span> <span class="text-primary fw-bold"> {{ $report['umumiyAslBaxo'] }} </span> </h5>||
    <h5><span class="fw-bold">Tavarlarning umumiy sotuv baxosi:</span> <span class="text-primary fw-bold"> {{ $report['umumiySotuvBaxo'] }} </span> </h5>||
    <h5><span class="fw-bold">Tavarlarning umumiy soni:</span> <span class="text-primary fw-bold"> {{ $report['umumiySoni'] }} </span></h5>
</div>
<hr>
<div class="col-lg-12">
