                        ...
                        <table class="table table-borderless datatable dataTable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-sortable="" style="width: 39.1837%;"><a href="#">Vaqt</a></th>
                            ...
                            <tbody>
                                @forelse($sotuvlar as $sotuv)
                                    <tr>
                                        ...
                                        <td>
                                            @if($sotuv->client_id != null)
                                                <a href="{{route('sotuv_client.show',$sotuv->client_id)}}">{{ $sotuv->client($sotuv->client_id) }}</a>
                                            @else
                                                <a href="">Mijoz mavjud emas!</a>
                                            @endif
                                        </td>
