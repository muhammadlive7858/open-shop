...
<head>
  ...
  <link rel="icon" href="{{('taxer/assets/images/favicon-32x32.png')}}" type="image/png" />
  <!--plugins-->
  <link href="{{ asset('taxer/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet"/>
  <link href="{{ asset('taxer/assets/plugins/simplebar/css/simplebar.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/plugins/metismenu/css/metisMenu.min.css')}}" rel="stylesheet" />
  <!-- Bootstrap CSS -->
  <link href="{{ asset('taxer/assets/css/bootstrap.min.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/css/bootstrap-extended.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/css/style.css')}}" rel="stylesheet" />
  ...
  <!--Theme Styles-->
  <link href="{{ asset('taxer/assets/css/dark-theme.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/css/light-theme.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/css/semi-dark.css')}}" rel="stylesheet" />
  <link href="{{ asset('taxer/assets/css/header-colors.css')}}" rel="stylesheet" />
...
<body>
       ...
       <!--end top header-->
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          <div class="sidebar-header">
            ...
            <div>
              <h4 class="logo-text">{{ env('APP_NAME') }} & Taxer</h4>
            </div>
          ...
          <ul class="metismenu" id="menu">
            ...
            <li class="menu-label">Soliqchilar</li>
            <li>
              <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="bi bi-droplet-fill"></i>
                </div>
                <div class="menu-title">Soliq inspektorlari</div>
              </a>
              <!-- <ul>
                <li> <a href="widgets-static-widgets.html"><i class="bi bi-circle"></i>Soliqchi amallari</a>
                </li>
              </ul> -->
            </li>
            <!-- <li>
            ...
            <!-- <li>
              <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Soliqchi amallari</div>
              </a> -->
              <!-- <ul>
            ...
            <li class="menu-label">So'ravlar</li>
            <!-- <li>
              <a class="has-arrow" href="javascript:;">
            ...
            <li>
              <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">So'ravlar</div>
              </a>
              <ul>
                <li> <a href="table-basic-table.html"><i class="bi bi-circle"></i>Aktivlar</a>
                </li>
                <li> <a href="table-advance-tables.html"><i class="bi bi-circle"></i>Tekshirilganlar</a>
                </li>
                <li> <a href="table-datatable.html"><i class="bi bi-circle"></i>Hamma so'ravlar</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li> <a href="authentication-signin.html"><i class="bi bi-circle"></i>Sign In</a>
                </li>
                <li> <a href="authentication-signup.html"><i class="bi bi-circle"></i>Sign Up</a>
                </li>
                <li> <a href="authentication-signin-with-header-footer.html"><i class="bi bi-circle"></i>Sign In with Header & Footer</a>
                </li>
                <li> <a href="authentication-signup-with-header-footer.html"><i class="bi bi-circle"></i>Sign Up with Header & Footer</a>
                </li>
                <li> <a href="authentication-forgot-password.html"><i class="bi bi-circle"></i>Forgot Password</a>
                </li>
                <li> <a href="authentication-reset-password.html"><i class="bi bi-circle"></i>Reset Password</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                <li> <a href="pages-errors-404-error.html"><i class="bi bi-circle"></i>404 Error</a>
                </li>
                <li> <a href="pages-errors-500-error.html"><i class="bi bi-circle"></i>500 Error</a>
                </li>
                <li> <a href="pages-errors-coming-soon.html"><i class="bi bi-circle"></i>Coming Soon</a>
                </li>
                <li> <a href="pages-blank-page.html"><i class="bi bi-circle"></i>Blank Page</a>
                </li>
              </ul>
            </li>
            <li>
  ...
  <!-- Bootstrap bundle JS -->
  <script src="{{   asset('taxer/assets/js/bootstrap.bundle.min.js')}}"></script>
  <!--plugins-->
  <script src="{{   asset('taxer/assets/js/jquery.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/simplebar/js/simplebar.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/metismenu/js/metisMenu.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
  <script src="{{   asset('taxer/assets/js/pace.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/chartjs/js/Chart.min.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/chartjs/js/Chart.extension.js')}}"></script>
  <script src="{{   asset('taxer/assets/plugins/apexcharts-bundle/js/apexcharts.min.js')}}"></script>
  <!--app-->
  <script src="{{   asset('taxer/assets/js/app.js')}}"></script>
  <script src="{{   asset('taxer/assets/js/index.js')}}"></script>
  <script>
