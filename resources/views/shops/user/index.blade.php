              ...
              <div class="col-xl-8">
                ...
                <div class="card">
                  <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2 row">
                      ...
                      <div class=" tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-9 col-md-8">{{ $user->market_name }}</div>
                        </div>
                      ...
                      <form action="{{ route('profile.update',$user->id) }}" method="post" class="tab-pane fade profile-edit pt-3" id="profile-edit" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT') --}}
                        <!-- Profile Edit Form -->
                        <form>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <textarea  class="form-control" id="about" style="height: 100px" name="description">{{ $user->description }}.</textarea>
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input  type="text" class="form-control" id="company" name="market_name" value="{{ $user->market_name }}">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input  type="text" class="form-control" id="Job" name="job" value="{{ $user->job }}" readonly>
                            </div>
                          </div>
